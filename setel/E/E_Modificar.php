...
<body>
    <div id="wrapper">
        ...
        <!-- /. NAV SIDE Título  -->
			...
			<!-- Datos del paciente -->
				...
				?>
				<form action="E_Modificar_2.php?No_expediente=<?php echo $user['No_expediente']; ?>" method="post">
				&nbsp;NÚMERO DE EXPEDIENTE: <input type="text" name="nu_expediente" id="nu_expediente" onkeyup="copiar()" onkeypress="return pulsar(event)"/>
				...
				&nbsp;CAMA: <input type="text" name="cama" id="cama" onkeyup="saltar(event,'nombre')" size="1"onkeypress="return pulsar(event)"/> <input type="submit" name="btnbuscar" value="BUSCAR"/><br><br>
				</form>
	...
	<!-- Tabla de información -->
		...
		<tr class="alt"><td>FECHA DE NACIMIENTO <input type="date" name="fnacimiento"id="fnacimiento"onkeyup="saltar(event,'noexpediente')"onkeypress="return pulsar(event)"/></td><td>UI <input type="text"size="2" name="iu" id="iu"onkeyup="saltar(event,'dx')"onkeypress="return pulsar(event)"/></td><td><strong>Estado metabólico</strong></td><td>
		<table>
		<tbody>
		...
		<!-- Botón de insercción -->
		<center><input type="submit" style="font-size:20px" value="MODIFICAR" name="btnguardar"id="guardar"/></center>
		<br><br>
		</form>
		</div>
		</div>
