...
//Query de consulta	
$sql = "SELECT * FROM Datos_del_paciente where No_expediente= '$exp'and turno='$turn' and fecha='$fecha_actual'";
...
<center><strong>MOVIMIENTO DIARIO DE PACIENTES EN <?php echo "$unidad"?></strong></center>
