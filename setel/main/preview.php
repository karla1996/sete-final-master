...
<?php include('navfixed.php');?>
 ...
 <ul class="nav nav-second-level">
	...
	<div class="span10">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Regresar a Salidas</button></a>

<div class="content" id="content">
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	<div style="width: 100%; height: 190px;" >
	<div style="width: 900px; float: left;">
	<center><div style="font:bold 25px 'Aleo';">SETEL</div>
	Registro de Salidas<br>
	Centro Estatal de Cuidados Criticos Salamanca	<br>	<br>
	</center>
	<div>
	<?php
	$resulta = $db->prepare("SELECT * FROM sales_order WHERE transaction_id= :a");
...
<div class="pull-right" style="margin-right:100px;">
		<a href="javascript:Clickheretoprint()" style="font-size:20px;"><button class="btn btn-success btn-large"><i class="icon-print"></i> Generar PDF</button></a>
		</div>	
</div>
</div>
